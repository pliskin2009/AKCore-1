...
{
	(DWORD64) 1 << DBO_GUILD_FUNCTION_MAX_MEMBER_20 | 			// 유파 20명
	...
	(DWORD64) 1 << DBO_GUILD_FUNCTION_MAX_MEMBER_30 |			// 유파 멤버 30명
	(DWORD64) 1 << DBO_GUILD_FUNCTION_MAX_SECOND_MASTER_2 | 	// 유파 사범 2명
	(DWORD64) 1 << DBO_GUILD_FUNCTION_MAX_MEMBER_40 |			// 유파 멤버 40명
	(DWORD64) 1 << DBO_GUILD_FUNCTION_CAN_CHANGE_NAME |			// 유파 이름 변경
	(DWORD64) 1 << DBO_GUILD_FUNCTION_MAX_MEMBER_50 |			// 유파 멤버 50명
	(DWORD64) 1 << DBO_GUILD_FUNCTION_MAX_SECOND_MASTER_3 |		// 유파 사범 3명
	(DWORD64) 1 << DBO_GUILD_FUNCTION_CAN_SET_EMBLEM |			// 유파 엠블렘 설정
	(DWORD64) 1 << DBO_GUILD_FUNCTION_MAX_MEMBER_60 |			// 유파 멤버 60명
	(DWORD64) 1 << DBO_GUILD_FUNCTION_MAX_MEMBER_70 |			// 유파 멤버 70명
	...
	(DWORD64) 1 << DBO_GUILD_FUNCTION_MAX_MEMBER_80 |			// 유파 멤버 80명
	(DWORD64) 1 << DBO_GUILD_FUNCTION_DOJO_UPGRADE_1 |			// 유파 도장 업그레이드1
	(DWORD64) 1 << DBO_GUILD_FUNCTION_CAN_MAKE_DOGI |			// 유파 도복
	(DWORD64) 1 << DBO_GUILD_FUNCTION_CAN_MAKE_DOJO_DOGI |		// 유파 도장 도복
...
{
	{ DBO_GUILD_FUNCTION_MAX_MEMBER_20,				DBO_GUILD_FUNCTION_INVALID,					eDBO_FUNC_TYPE_GUILD_PASSIVE,		0,			0,			 0 },
	...
	{ DBO_GUILD_FUNCTION_WAREHOUSE,					DBO_GUILD_FUNCTION_INVALID,					eDBO_FUNC_TYPE_GUILD_PASSIVE,		1000,		10000,       0 },
	{ DBO_GUILD_FUNCTION_MAX_MEMBER_30,				DBO_GUILD_FUNCTION_MAX_MEMBER_20,			eDBO_FUNC_TYPE_GUILD_PASSIVE,		2000,		5000,        0 },
	{ DBO_GUILD_FUNCTION_MAX_SECOND_MASTER_2,		DBO_GUILD_FUNCTION_MAX_SECOND_MASTER_1,		eDBO_FUNC_TYPE_GUILD_PASSIVE,		3000,		5000,        0 },
	{ DBO_GUILD_FUNCTION_MAX_MEMBER_40,				DBO_GUILD_FUNCTION_MAX_MEMBER_30,			eDBO_FUNC_TYPE_GUILD_PASSIVE,		4000,		5000,        0 },
	{ DBO_GUILD_FUNCTION_CAN_CHANGE_NAME,			DBO_GUILD_FUNCTION_INVALID,					eDBO_FUNC_TYPE_GUILD_ACTIVE,		5000,		100000,      0 },
	{ DBO_GUILD_FUNCTION_MAX_MEMBER_50,				DBO_GUILD_FUNCTION_MAX_MEMBER_40,			eDBO_FUNC_TYPE_GUILD_PASSIVE,		6000,		10000,       0 },
	{ DBO_GUILD_FUNCTION_MAX_SECOND_MASTER_3,		DBO_GUILD_FUNCTION_MAX_SECOND_MASTER_2,		eDBO_FUNC_TYPE_GUILD_PASSIVE,		7000,		10000,       0 },
	{ DBO_GUILD_FUNCTION_CAN_SET_EMBLEM,			DBO_GUILD_FUNCTION_INVALID,					eDBO_FUNC_TYPE_GUILD_PASSIVE,		8000,		20000,       0 },
	{ DBO_GUILD_FUNCTION_MAX_MEMBER_60,				DBO_GUILD_FUNCTION_MAX_MEMBER_50,			eDBO_FUNC_TYPE_GUILD_PASSIVE,		9000,		10000,       0 },
	{ DBO_GUILD_FUNCTION_MAX_MEMBER_70,				DBO_GUILD_FUNCTION_MAX_MEMBER_60,			eDBO_FUNC_TYPE_GUILD_PASSIVE,		10000,		10000,       0 },
	{ DBO_GUILD_FUNCTION_MAX_SECOND_MASTER_4,		DBO_GUILD_FUNCTION_MAX_SECOND_MASTER_3,		eDBO_FUNC_TYPE_GUILD_PASSIVE,		10000,		20000,       0 },
	
	{ DBO_GUILD_FUNCTION_CAN_HAVE_DOJO,				DBO_GUILD_FUNCTION_INVALID,					eDBO_FUNC_TYPE_DOJO_PASSIVE,		10000,		50000,       0 },
	{ DBO_GUILD_FUNCTION_CAN_USE_DOJO_TELEPORT,		DBO_GUILD_FUNCTION_CAN_HAVE_DOJO,			eDBO_FUNC_TYPE_DOJO_PASSIVE,		10000,		1000,		 0 },
	
	{ DBO_GUILD_FUNCTION_MAX_MEMBER_80,				DBO_GUILD_FUNCTION_MAX_MEMBER_70,			eDBO_FUNC_TYPE_GUILD_PASSIVE,		12000,		20000,       0 },
	
	{ DBO_GUILD_FUNCTION_DOJO_UPGRADE_1,			DBO_GUILD_FUNCTION_CAN_HAVE_DOJO,			eDBO_FUNC_TYPE_DOJO_PASSIVE,		12000,		30000,       0 },
	{ DBO_GUILD_FUNCTION_CAN_MAKE_DOGI,				DBO_GUILD_FUNCTION_INVALID,					eDBO_FUNC_TYPE_GUILD_PASSIVE,		12000,		20000,		 0 },
	{ DBO_GUILD_FUNCTION_CAN_MAKE_DOJO_DOGI,		DBO_GUILD_FUNCTION_CAN_HAVE_DOJO,			eDBO_FUNC_TYPE_DOJO_PASSIVE,		12000,		20000,		 0 },

	{ DBO_GUILD_FUNCTION_CAN_CHANGE_EMBLEM,			DBO_GUILD_FUNCTION_CAN_SET_EMBLEM,			eDBO_FUNC_TYPE_GUILD_ACTIVE,		14000,		100000,      0 },
	
	{ DBO_GUILD_FUNCTION_DOJO_UPGRADE_2,			DBO_GUILD_FUNCTION_DOJO_UPGRADE_1,			eDBO_FUNC_TYPE_DOJO_PASSIVE,		14000,		50000,       0 },
	{ DBO_GUILD_FUNCTION_TENKAICHI_SEED,			DBO_GUILD_FUNCTION_CAN_HAVE_DOJO,			eDBO_FUNC_TYPE_DOJO_PASSIVE,		14000,		0,			 0 },
	
	{ DBO_GUILD_FUNCTION_MAX_MEMBER_90,				DBO_GUILD_FUNCTION_MAX_MEMBER_80,			eDBO_FUNC_TYPE_GUILD_PASSIVE,		16000,		30000,       0 },
	
	{ DBO_GUILD_FUNCTION_DOJO_UPGRADE_3,			DBO_GUILD_FUNCTION_DOJO_UPGRADE_2,			eDBO_FUNC_TYPE_DOJO_PASSIVE,		18000,		100000,      5 },
	...
	{ DBO_GUILD_FUNCTION_MAX_MEMBER_100,			DBO_GUILD_FUNCTION_MAX_MEMBER_90,			eDBO_FUNC_TYPE_GUILD_PASSIVE,		20000,		50000,       0 },
	
	{ DBO_GUILD_FUNCTION_DOJO_UPGRADE_4,			DBO_GUILD_FUNCTION_DOJO_UPGRADE_3,			eDBO_FUNC_TYPE_DOJO_PASSIVE,		20000,		500000,      0 },
	{ DBO_GUILD_FUNCTION_CAN_CHANGE_DOGI,			DBO_GUILD_FUNCTION_CAN_MAKE_DOGI,			eDBO_FUNC_TYPE_GUILD_ACTIVE,		20000,		100000,      0 },
	{ DBO_GUILD_FUNCTION_CAN_CHANGE_DOJO_DOGI,		DBO_GUILD_FUNCTION_CAN_MAKE_DOJO_DOGI,		eDBO_FUNC_TYPE_DOJO_ACTIVE,			20000,		100000,      0 },
	{ DBO_GUILD_FUNCTION_DOJO_UPGRADE_5,			DBO_GUILD_FUNCTION_DOJO_UPGRADE_4,			eDBO_FUNC_TYPE_DOJO_PASSIVE,		22000,		1000000,     10 },
	{ DBO_GUILD_FUNCTION_DOJO_QUEST_2,				DBO_GUILD_FUNCTION_DOJO_QUEST_1,			eDBO_FUNC_TYPE_DOJO_PASSIVE,		22000,		0,			 0 },
	{ DBO_GUILD_FUNCTION_DOJO_VEHICLE,				DBO_GUILD_FUNCTION_CAN_HAVE_DOJO,			eDBO_FUNC_TYPE_DOJO_ACTIVE,			22000,		100000,      0 },
	{ DBO_GUILD_FUNCTION_DOJO_UPGRADE_6,			DBO_GUILD_FUNCTION_DOJO_UPGRADE_5,			eDBO_FUNC_TYPE_DOJO_PASSIVE,		25000,		2000000,     0 },
	{ DBO_GUILD_FUNCTION_CAN_HAVE_BOOK,				DBO_GUILD_FUNCTION_CAN_HAVE_DOJO,			eDBO_FUNC_TYPE_DOJO_ACTIVE,			25000,		500000,      0 },
	{ DBO_GUILD_FUNCTION_DOJO_SKILL,				DBO_GUILD_FUNCTION_CAN_HAVE_DOJO,			eDBO_FUNC_TYPE_DOJO_ACTIVE,			25000,		3000000,     0 },
	{ DBO_GUILD_FUNCTION_DOJO_UPGRADE_7,			DBO_GUILD_FUNCTION_DOJO_UPGRADE_6,			eDBO_FUNC_TYPE_DOJO_PASSIVE,		30000,		5000000,     20 },
...
{
	if (false != Dbo_HasGuildFunction(qwGuildFunctionFlag, DBO_GUILD_FUNCTION_MAX_MEMBER_100))
	{
		return 100;
	}
	...
	else if (false != Dbo_HasGuildFunction(qwGuildFunctionFlag, DBO_GUILD_FUNCTION_MAX_MEMBER_80))
	{
		return 80;
	}
	...
	else if (false != Dbo_HasGuildFunction(qwGuildFunctionFlag, DBO_GUILD_FUNCTION_MAX_MEMBER_60))
	{
		return 60;
	}
	...
	else if (false != Dbo_HasGuildFunction(qwGuildFunctionFlag, DBO_GUILD_FUNCTION_MAX_MEMBER_40))
	{
		return 40;
	}
	...
	else if (false != Dbo_HasGuildFunction(qwGuildFunctionFlag, DBO_GUILD_FUNCTION_MAX_MEMBER_20))
	{
		return 20;
	}
	else
