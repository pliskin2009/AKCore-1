...
const DWORD		NTL_MAX_BASIC_MAIL_SEND_ZENNY	= 10;		// 수수료
const DWORD		NTL_MAX_ATTACH_MAIL_SEND_ZENNY	= 10;		// 수수료
const DWORD		NTL_MAX_MAIL_SEND_ZENNY_AMOUNTS	= 100000;	// 첨부 최대가능 금액
...
struct sMAIL_DATA
{
	...
	WCHAR				wszFromName[NTL_MAX_SIZE_CHAR_NAME_UNICODE + 1];		// 보낸 캐릭 이름
	BYTE				byTextSize;
